...
if (version_compare(PHP_VERSION, '5.6.0') < 0) {
  print 'Your PHP installation is too old. Silkscreen CMS requires at least PHP 5.6.0. See the <a href="https://backdropcms.org/guide/requirements">System Requirements</a> page for more information.';
  exit;
}
...
function update_info_page() {
  ...
  $output = '<p>Use this utility to update your database whenever you install a new version of Silkscreen CMS or one of the site\'s modules.</p>';
